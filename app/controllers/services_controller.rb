class ServicesController < ApplicationController
  ...
  private
    ...
    def service_params
      params.require(:service).permit(:photo, :title, :description, :address, :email, :phone, :telephone, :website, :monday, :tuesday, :wednesday, :thursday,:friday,:saturday,:sunday,:morning_start,:morning_end,:afternoon_start,:afternoon_end, :smoking ,category_ids: [])
    end
end
